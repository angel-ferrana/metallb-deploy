pipeline {
    ...
    environment {
        GITHUB_URL = 'https://github.com/angel-ferrana/metallb-deploy.git'  // <---- Change this to match your cloned repository
        KUBECONFIG = credentials('ferrana-225')   // <---- Change this to match your kubernetes cluster credentials
    }
